...
/**
 *  Consider using {@link com.intellij.ide.ui.text.StyledTextPane} for custom text formatting
 */
public final class ChatTipUIUtil {
    private static final Logger LOG = Logger.getInstance(ChatTipUIUtil.class);
