...
public final class Utils {
     ...
     */
    @Nullable
    public static List<String> expandExplain(List<String> explains) {
        if (explains == null || explains.size() == 0)
            return explains;

        final LinkedHashSet<String> result = new LinkedHashSet<>(explains.size());
    ...
    public static String md5(String input) {
        ...
        try {
            ...
            mdInst.update(input.getBytes(StandardCharsets.UTF_8));
