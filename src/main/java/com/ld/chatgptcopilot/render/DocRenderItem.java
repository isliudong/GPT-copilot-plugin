...
import static com.ld.chatgptcopilot.render.InlineDocumentationImplKtKt.findInlineDocumentation;
...
public final class DocRenderItem {
    ...
    @Nls
    public String translateTextToRender;
    ...
    private void generateHtmlInBackgroundAndToggle() {
        ReadAction.nonBlocking(() -> DocRenderPassFactory.getText(getInlineDocumentation()))
    ...
    private void updateIcon(List<Runnable> foldingTasks) {
        ...
        if (iconEnabled != iconExists) {
            if (iconEnabled) {
                highlighter.setGutterIconRenderer(new MyGutterIconRenderer(ChatGPTCopilotIcons.pluginIcon, false));
            } else {
    ...
    class MyGutterIconRenderer extends GutterIconRenderer implements DumbAware {
        ...
        public String getTooltipText() {
            AnAction action = ActionManager.getInstance().getAction("ToggleRenderedDocPresentationOne");
    ...
    private static final class ToggleRenderingAction extends DumbAwareAction {
        ...
        private ToggleRenderingAction(DocRenderItem item) {
            super("Rendered Doc");
            copyFrom(ActionManager.getInstance().getAction("ToggleRenderedDocPresentationOne"));
            this.item = item;
        }
